...
-- 默认套餐
INSERT INTO `sys_package` (`id`, `package_name`, `package_code`, `price_monthly`, `price_yearly`, `max_users`, `max_roles`, `max_depts`, `max_process_definitions`, `max_wechat_accounts`, `max_storage_mb`, `sort_order`, `status`, `remark`) VALUES
(1, '免费版', 'FREE', 0.00, 0.00, 10, 5, 10, 5, 1, 1024, 1, 1, '免费体验套餐'),
(2, '基础版', 'BASIC', 299.00, 2990.00, 50, 20, 50, 20, 3, 10240, 2, 1, '适合小型团队'),
(3, '专业版', 'PRO', 999.00, 9990.00, 200, 50, 200, 0, 10, 102400, 3, 1, '适合中型企业，流程定义不限'),
(4, '旗舰版', 'ENTERPRISE', 0.00, 0.00, 0, 0, 0, 0, 0, 0, 4, 1, '按需定制，所有配额不限');
